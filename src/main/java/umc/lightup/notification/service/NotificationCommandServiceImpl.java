...
public class NotificationCommandServiceImpl implements NotificationCommandService {
  ...
  public Notification deleteNotification(long notificationId) {
    Notification notification = notificationRepository.findById(notificationId)
            .orElseThrow(() -> new GeneralHandler(ErrorStatus.NOTIFICATION_NOT_FOUND));
  ...
  @Override
  @Transactional
  public NotificationEventResponseDTO.NotificationEventDTO saveNotification(
          NotificationEventRequestDTO.NotificationEventDTO notificationEvent
  ) {
    Member sender = memberRepository.findById(notificationEvent.getSenderId())
            .orElseThrow(() -> new GeneralHandler(ErrorStatus.MEMBER_NOT_FOUND));

    Member receiver = memberRepository.findById(notificationEvent.getReceiverId())
            .orElseThrow(() -> new GeneralHandler(ErrorStatus.MEMBER_NOT_FOUND));
